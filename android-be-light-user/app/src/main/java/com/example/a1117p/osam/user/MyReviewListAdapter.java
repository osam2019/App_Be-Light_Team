...
public class MyReviewListAdapter extends BaseAdapter {
    ArrayList<MyReviewListItem> reviews = new ArrayList<>();
    MyReviewListAdapter(JSONArray jsonArray){
        for(Object object:jsonArray){
            reviews.add(new MyReviewListItem((JSONObject) object));
        }
    }
    @Override
    public int getCount() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MyReviewListItem listViewItem = reviews.get(position);
